...
/// <summary>
/// 对应 Joern semanticcpg/language/types/structure/MemberTraversal.scala。
///
...
public static class MemberTraversal
{
    ...
    public static Traversal Select(Traversal traversal)
    {
        ...
        return CpgNodeKind.Member == CpgNodeKind.Unknown ? traversal : traversal.OfKind(CpgNodeKind.Member);
    }
