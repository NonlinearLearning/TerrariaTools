...
namespace Infrastructure.Analysis.Engine.Passes.ControlFlow;
...
public sealed class CfgBuilder
{
    ...
    private CfgModel BuildStatement(StatementSyntax statement)
    {
        return statement switch
        {
            ...
            ReturnStatementSyntax returnStatement => BuildTerminal(returnStatement, FrontendControlFlowConventions.ReturnTerminal),
            ThrowStatementSyntax throwStatement => BuildTerminal(throwStatement, FrontendControlFlowConventions.ThrowTerminal),
            BreakStatementSyntax breakStatement => BuildTerminal(breakStatement, FrontendControlFlowConventions.BreakTerminal),
            ContinueStatementSyntax continueStatement => BuildTerminal(continueStatement, FrontendControlFlowConventions.ContinueTerminal),
    ...
    private CfgModel BuildTerminal(StatementSyntax statement, string terminalKind)
    {
        ...
        if (FrontendControlFlowConventions.IsReturnTerminal(terminalKind))
        {
            model.PendingReturns.Add(nodeId);
        }
        else if (FrontendControlFlowConventions.IsBreakTerminal(terminalKind))
        {
            model.PendingBreaks.Add(nodeId);
        }
        else if (FrontendControlFlowConventions.IsContinueTerminal(terminalKind))
        {
