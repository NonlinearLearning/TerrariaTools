...
internal static class DeleteClassReplaceDecisionFactory
{
    internal static DecisionUnit CreateLocalFunctionReplaceDecision(string ruleId, LocalFunctionStatementSyntax anchorNode, LocalFunctionStatementSyntax replacementNode, string reason)
    {
    ...
    internal static DecisionUnit CreateMethodReplaceDecision(string ruleId, MethodDeclarationSyntax anchorNode, MethodDeclarationSyntax replacementNode, string reason)
    {
    ...
    internal static DecisionUnit CreateInvocationReplaceDecision(string ruleId, InvocationExpressionSyntax anchorNode, InvocationExpressionSyntax replacementNode, string reason)
    {
        var anchorFragment = CreateFragment(anchorNode, "anchor", DecisionActionKind.Replace);
        var replacementFragment = CreateFragment(
          replacementNode.WithoutTrivia(),
    ...
    internal static DecisionUnit CreateExpressionReplaceDecision(string ruleId, ExpressionSyntax anchorNode, ExpressionSyntax replacementNode, string reason)
    {
        var anchorFragment = CreateFragment(anchorNode, "anchor", DecisionActionKind.Replace);
        var replacementFragment = CreateFragment(
          replacementNode.WithoutTrivia(),
    ...
    internal static DecisionUnit CreateIndexerReplaceDecision(string ruleId, IndexerDeclarationSyntax anchorNode, IndexerDeclarationSyntax replacementNode, string reason)
    {
        return CreateMemberDeclarationReplaceDecision(ruleId, anchorNode, replacementNode, reason);
    }

    internal static DecisionUnit CreateDelegateReplaceDecision(string ruleId, DelegateDeclarationSyntax anchorNode, DelegateDeclarationSyntax replacementNode, string reason)
    {
        return CreateMemberDeclarationReplaceDecision(ruleId, anchorNode, replacementNode, reason);
    }

    internal static DecisionUnit CreateElementAccessReplaceDecision(string ruleId, ElementAccessExpressionSyntax anchorNode, ElementAccessExpressionSyntax replacementNode, string reason)
    {
        var anchorFragment = CreateFragment(anchorNode, "anchor", DecisionActionKind.Replace);
        var replacementFragment = CreateFragment(
          replacementNode.WithoutTrivia(),
