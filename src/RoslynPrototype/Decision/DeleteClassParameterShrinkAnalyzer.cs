...
internal sealed class DeleteClassParameterShrinkAnalyzer
{
    ...
    internal bool TryBuildNamedArgumentMethodPlan(RuleContext context, TypeSyntax typeSyntax, out PrivateMethodParameterShrinkPlan plan)
    {
        plan = null!;
    ...
    internal bool TryBuildOptionalParameterMethodPlan(RuleContext context, TypeSyntax typeSyntax, out PrivateMethodParameterShrinkPlan plan)
    {
        plan = null!;
    ...
    internal bool TryBuildParamsMethodPlan(RuleContext context, TypeSyntax typeSyntax, out PrivateMethodParameterShrinkPlan plan)
    {
        plan = null!;
    ...
    internal bool TryBuildPrivateMethodPlan(RuleContext context, TypeSyntax typeSyntax, out PrivateMethodParameterShrinkPlan plan)
    {
    ...
    internal bool TryBuildPublicMethodPlan(RuleContext context, TypeSyntax typeSyntax, out PublicMethodParameterShrinkPlan plan)
    {
    ...
    internal bool TryBuildLocalFunctionPlan(RuleContext context, TypeSyntax typeSyntax, out LocalFunctionParameterShrinkPlan plan)
    {
        plan = null!;
    ...
    internal bool TryBuildNamedArgumentLocalFunctionPlan(RuleContext context, TypeSyntax typeSyntax, out LocalFunctionParameterShrinkPlan plan)
    {
        plan = null!;
    ...
    internal bool TryBuildOptionalParameterLocalFunctionPlan(RuleContext context, TypeSyntax typeSyntax, out LocalFunctionParameterShrinkPlan plan)
    {
        plan = null!;
    ...
    internal bool TryBuildIndexerPlan(RuleContext context, TypeSyntax typeSyntax, out IndexerParameterShrinkPlan plan)
    {
        plan = null!;
    ...
    internal bool TryBuildNamedArgumentIndexerPlan(RuleContext context, TypeSyntax typeSyntax, out IndexerParameterShrinkPlan plan)
    {
        plan = null!;
    ...
    internal bool TryBuildDelegatePlan(RuleContext context, TypeSyntax typeSyntax, out DelegateParameterShrinkPlan plan)
    {
        plan = null!;
    ...
    internal bool TryBuildDelegateMethodGroupPlan(RuleContext context, TypeSyntax typeSyntax, out DelegateComplexShrinkPlan plan)
    {
        plan = null!;
    ...
    internal bool TryBuildDelegateLambdaPlan(RuleContext context, TypeSyntax typeSyntax, out DelegateComplexShrinkPlan plan)
    {
        plan = null!;
    ...
    internal bool TryBuildDelegateInvocationChainPlan(RuleContext context, TypeSyntax typeSyntax, out DelegateComplexShrinkPlan plan)
    {
        plan = null!;
    ...
    internal bool TryBuildExtensionReceiverNonFirstParameterPlan(RuleContext context, TypeSyntax typeSyntax, out PrivateMethodParameterShrinkPlan plan)
    {
        plan = null!;
    ...
    internal static bool TryResolveLocalFunctionParameter(TypeSyntax typeSyntax, out LocalFunctionStatementSyntax localFunction, out ParameterSyntax parameter, out int parameterIndex)
    {
        localFunction = null!;
        parameter = null!;
        parameterIndex = -1;
    ...
    internal static bool TryResolveIndexerParameter(TypeSyntax typeSyntax, out IndexerDeclarationSyntax indexer, out ParameterSyntax parameter, out int parameterIndex)
    {
        indexer = null!;
        parameter = null!;
        parameterIndex = -1;
    ...
    internal static bool TryResolveDelegateParameter(TypeSyntax typeSyntax, out DelegateDeclarationSyntax delegateDeclaration, out ParameterSyntax parameter, out int parameterIndex)
    {
    ...
    internal static bool TryCollectDelegateUsageSummary(RuleContext context, INamedTypeSymbol delegateSymbol, IParameterSymbol parameterSymbol, int parameterIndex, out DelegateUsageSummary usageSummary)
    {
    ...
    internal static bool TryBuildReplacementMethod(MethodDeclarationSyntax method, ParameterSyntax parameter, out MethodDeclarationSyntax replacementMethod)
    {
    ...
    internal static bool TryBuildReplacementLocalFunction(LocalFunctionStatementSyntax localFunction, ParameterSyntax parameter, out LocalFunctionStatementSyntax replacementLocalFunction)
    {
    ...
    internal static bool TryBuildReplacementIndexer(IndexerDeclarationSyntax indexer, ParameterSyntax parameter, out IndexerDeclarationSyntax replacementIndexer)
    {
    ...
    internal static bool TryBuildReplacementDelegate(DelegateDeclarationSyntax delegateDeclaration, ParameterSyntax parameter, out DelegateDeclarationSyntax replacementDelegate)
    {
    ...
    internal static bool TryBuildReplacementInvocation(InvocationExpressionSyntax invocation, int parameterIndex, int expectedParameterCount, out InvocationExpressionSyntax replacementInvocation)
    {
    ...
    internal static bool TryBuildNamedArgumentReplacementInvocation(InvocationExpressionSyntax invocation, IInvocationOperation invocationOperation, IParameterSymbol parameterSymbol, out InvocationExpressionSyntax replacementInvocation)
    {
        replacementInvocation = null!;
    ...
    internal static bool TryBuildOptionalReplacementInvocation(InvocationExpressionSyntax invocation, IInvocationOperation invocationOperation, IParameterSymbol parameterSymbol, out InvocationExpressionSyntax replacementInvocation, out bool changed)
    {
    ...
    internal static bool TryBuildMappedInvocationReplacement(InvocationExpressionSyntax invocation, IInvocationOperation? invocationOperation, IParameterSymbol parameterSymbol, out InvocationExpressionSyntax replacementInvocation)
    {
        replacementInvocation = null!;
    ...
    internal static bool TryBuildNamedArgumentReplacementElementAccess(ElementAccessExpressionSyntax elementAccess, IPropertyReferenceOperation propertyReference, IParameterSymbol parameterSymbol, out ElementAccessExpressionSyntax replacementElementAccess)
    {
    ...
    internal static bool TryBuildLambdaRewrite(RuleContext context, SemanticModel semanticModel, ExpressionSyntax expression, IAnonymousFunctionOperation anonymousFunction, int parameterIndex, out ExpressionRewrite lambdaRewrite)
    {
        lambdaRewrite = null!;
    ...
    internal static bool TryBuildReplacementElementAccess(ElementAccessExpressionSyntax elementAccess, int parameterIndex, int expectedParameterCount, out ElementAccessExpressionSyntax replacementElementAccess)
    {
        replacementElementAccess = null!;
    ...
    internal static bool HasDelegateReferences(Compilation compilation, INamedTypeSymbol delegateSymbol)
    {
    ...
    internal static bool HasConflictingReplacementOverload(IMethodSymbol methodSymbol, int parameterIndex)
    {
