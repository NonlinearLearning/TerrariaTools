...
{
    internal static IEnumerable<DelegateUsagePayload> EnumeratePayloads(IReadOnlyList<PropagatedMarkRecord> propagatedMarks, DelegateUsageMode mode)
    {
    ...
    internal static bool TryBuildReplacement(DelegateUsagePayload payload, out DelegateDeclarationSyntax replacementDelegate)
    {
...
{
    internal static IEnumerable<ExtensionMethodMappedCallsitePayload> EnumeratePayloads(IReadOnlyList<PropagatedMarkRecord> propagatedMarks)
    {
        var seenKeys = new HashSet<string>(StringComparer.Ordinal);
        foreach (var propagatedMark in propagatedMarks)
        {
    ...
    internal static bool TryBuildReplacement(ExtensionMethodMappedCallsitePayload payload, out MethodDeclarationSyntax replacementMethod)
    {
    ...
    internal static IEnumerable<DecisionUnit> CreateInvocationReplaceDecisions(string ruleId, Compilation compilation, ExtensionMethodMappedCallsitePayload payload, string reason)
    {
