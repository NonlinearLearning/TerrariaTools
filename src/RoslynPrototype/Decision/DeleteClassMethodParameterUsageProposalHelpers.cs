...
{
    internal static IEnumerable<MethodParameterUsagePayload> EnumerateMethodPayloads(IReadOnlyList<PropagatedMarkRecord> propagatedMarks, MethodParameterUsageMode mode)
    {
    ...
    internal static bool TryBuildReplacementMethod(MethodParameterUsagePayload payload, out MethodDeclarationSyntax replacementMethod)
    {
    ...
    internal static IEnumerable<DecisionUnit> CreateInvocationReplaceDecisions(string ruleId, Compilation compilation, MethodParameterUsagePayload payload, string reason)
    {
    ...
    private static bool TryBuildReplacementInvocation(Compilation compilation, MethodParameterUsagePayload payload, InvocationExpressionSyntax invocation, IParameterSymbol parameterSymbol, out InvocationExpressionSyntax replacementInvocation)
    {
    ...
    private static bool TryResolveMethodParameterSymbol(Compilation compilation, MethodParameterUsagePayload payload, out IParameterSymbol parameterSymbol)
    {
