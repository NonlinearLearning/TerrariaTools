...
internal static class DeleteSObjectProposalHelpers
{
    internal static readonly IReadOnlyList<SyntaxKind> LogicalConflictNodeKinds =
      new[]
      {
    ...
    internal static readonly IReadOnlyList<SyntaxKind> IfConflictNodeKinds =
      new[]
      {
        SyntaxKind.IfStatement
      };

    internal static readonly IReadOnlyList<SyntaxKind> ControlConflictNodeKinds =
      new[]
      {
    ...
    internal static readonly IReadOnlyList<SyntaxKind> DefaultConflictNodeKinds =
      new[]
      {
        SyntaxKind.IfStatement,
        SyntaxKind.ForStatement,
    ...
    internal static readonly IReadOnlyList<SyntaxKind> MergeableNodeKinds =
      new[]
      {
    ...
    internal static IReadOnlyList<(MarkRecord Mark, MarkRecord SourceMark)> EnumerateDerivedMarks(IReadOnlyList<PropagatedMarkRecord> propagatedMarks, IReadOnlyList<LiftedMarkRecord> liftedMarks)
    {
    ...
    internal static IReadOnlyList<(MarkRecord Mark, MarkRecord SourceMark)> EnumerateActiveDerivedMarks(IReadOnlyList<PropagatedMarkRecord> propagatedMarks, IReadOnlyList<LiftedMarkRecord> liftedMarks)
    {
    ...
    internal static IEnumerable<MarkRecord> EnumerateUncoveredSeedMarks(IReadOnlyList<MarkRecord> seedMarks, IReadOnlyList<PropagatedMarkRecord> propagatedMarks, IReadOnlyList<LiftedMarkRecord> liftedMarks)
    {
    ...
    internal static bool IsSymbolReferencePropagation(PropagatedMarkRecord propagatedMark)
    {
    ...
    internal static IEnumerable<LogicalHostPayload> EnumerateLogicalHostPayloads(IReadOnlyList<PropagatedMarkRecord> propagatedMarks)
    {
        return propagatedMarks
    ...
    internal static IEnumerable<IfStructureCompletionPayload> EnumerateIfStructureCompletionPayloads(IReadOnlyList<PropagatedMarkRecord> propagatedMarks)
    {
        return propagatedMarks
    ...
    internal static HashSet<(int Start, int Length, int RawKind)> BuildCoveredSeedKeys(IReadOnlyList<MarkRecord> seedMarks, IReadOnlyList<MarkRecord> propagatedMarks)
    {
    ...
    internal static ExpressionSyntax? BuildLogicalReplacement(LogicalHostPayload payload)
    {
    ...
    internal static DecisionUnit CreateLogicalReplaceDecision(string ruleId, BinaryExpressionSyntax anchorNode, ExpressionSyntax replacementNode)
    {
    ...
    internal static bool TryBuildIfStructureDecisionFromMark(string ruleId, IfStructureCompletionPayload payload, out DecisionUnit? decision, out IReadOnlyList<SyntaxNode> consumedNodes)
    {
        decision = null;
        ...
        switch (payload.Kind)
        {
            ...
            case IfStructureCompletionKind.DeleteWholeIf:
                decision = RuleAnalysisHelpers.CreateDeleteDecision(
                  ruleId,
                  payload.AnchorIf,
    ...
    internal static DecisionUnit CreateStatementReplaceDecision(string ruleId, StatementSyntax anchorNode, StatementSyntax replacementNode, string reason)
    {
        var anchorFragment = DecisionCpgFactory.CreateFragment(
          BuildFragmentId(anchorNode),
          anchorNode,
    ...
    internal static DecisionUnit CreateElseClauseReplaceDecision(string ruleId, ElseClauseSyntax anchorNode, ElseClauseSyntax replacementNode, string reason)
    {
        var anchorFragment = DecisionCpgFactory.CreateFragment(
          BuildFragmentId(anchorNode),
          anchorNode,
    ...
    internal static bool TryResolveMarkedIfStructure(RuleContext context, SyntaxNode markedNode, IfStructureAnalyzer ifStructureAnalyzer, out IfStructureAnalysis? ifAnalysis)
    {
        ifAnalysis = null;
        ...
        {
            ifAnalysis = ifStructureAnalyzer.Analyze(elseIfStatement, context.AnalysisContext);
            return true;
        }
    ...
    internal static IfStructureCompletionPayload? TryBuildIfStructureCompletionPayload(RuleContext context, SyntaxNode markedNode)
    {
    ...
    internal static SyntaxNode GetIfStructureDecisionNode(IfStructureCompletionPayload payload)
    {
