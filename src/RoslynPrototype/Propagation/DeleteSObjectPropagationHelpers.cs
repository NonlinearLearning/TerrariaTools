...
internal static class DeleteSObjectPropagationHelpers
{
    ...
    internal static LogicalHostPayload? TryBuildLogicalHostPayload(RuleContext context, BinaryExpressionSyntax host, IEnumerable<SyntaxNode> sourceNodes)
    {
    ...
    internal static IEnumerable<PropagatedMarkRecord> EnumerateIfStructureCompletionPropagations(RuleContext context, IReadOnlyList<MarkRecord> seedMarks, string ruleId)
    {
