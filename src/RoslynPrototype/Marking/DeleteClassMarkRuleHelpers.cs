...
internal static class DeleteClassMarkRuleHelpers
{
    ...
    internal static IEnumerable<MarkRecord> BuildDeclarationMarks(RuleContext context, SyntaxNode root, string ruleId)
    {
    ...
    internal static IEnumerable<MarkRecord> BuildExpressionMarks(RuleContext context, SyntaxNode root, string ruleId, IReadOnlyCollection<SyntaxKind> allowedKinds)
    {
        var targetClassNames = ParseTargetClassNames(context);
        if (targetClassNames.Count == 0)
        {
    ...
    internal static IEnumerable<MarkRecord> BuildTypeSyntaxMarks(RuleContext context, SyntaxNode root, string ruleId, IReadOnlyCollection<SyntaxKind> allowedKinds)
    {
        var targetClassNames = ParseTargetClassNames(context);
        if (targetClassNames.Count == 0)
        {
    ...
    private static bool HasTargetAncestorExpression(RuleContext context, ExpressionSyntax expression, IReadOnlyList<string> targetClassNames)
    {
    ...
    private static bool HasTargetDescendantType(RuleContext context, TypeSyntax typeSyntax, IReadOnlyList<string> targetClassNames)
    {
    ...
    private static bool HasTargetAncestorType(RuleContext context, TypeSyntax typeSyntax, IReadOnlyList<string> targetClassNames)
    {
    ...
    private static bool ReferencesTargetType(RuleContext context, ExpressionSyntax expression, IReadOnlyList<string> targetClassNames)
    {
    ...
    private static bool ReferencesTargetType(RuleContext context, TypeSyntax typeSyntax, IReadOnlyList<string> targetClassNames)
    {
    ...
    private static bool ReferencesTargetType(IOperation operation, IReadOnlyList<string> targetClassNames)
    {
    ...
    private static bool MatchesTargetSymbol(ISymbol? symbol, IReadOnlyList<string> targetClassNames)
    {
        if (symbol is null)
        {
            return false;
    ...
    private static bool MatchesTargetType(ITypeSymbol? typeSymbol, IReadOnlyList<string> targetClassNames)
    {
