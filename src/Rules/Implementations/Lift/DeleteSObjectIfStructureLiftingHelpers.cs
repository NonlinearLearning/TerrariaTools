...
{
    internal static IEnumerable<LiftedMarkRecord> BuildIfStructureLiftedMarks(
      RuleContext context,
      string ruleId,
    ...
    private static IReadOnlyList<MarkRecord> BuildStructuralMarksForLiftedNode(
      RuleContext context,
      string ruleId,
    ...
    private static bool TryResolveMarkedIfStructure(
      RuleContext context,
      SyntaxNode markedNode,
      IfStructureAnalyzer ifStructureAnalyzer,
