...
internal static class DeleteSObjectSwitchLiftingHelpers
{
    internal static IEnumerable<LiftedMarkRecord> BuildSwitchLiftedMarks(
      string ruleId,
    ...
    private static IReadOnlyList<MarkRecord> BuildSwitchMarks(
      string ruleId,
    ...
    private static bool AllNonDefaultSectionsMarked(
      SwitchStatementSyntax switchStatement,
      IReadOnlySet<(int Start, int Length, int RawKind)> markKeys,
      IReadOnlyList<MarkRecord> synthesizedMarks)
    {
    ...
    private static bool IsSwitchSectionFullyMarked(
    ...
    private static IEnumerable<StatementSyntax> EnumerateExecutableCaseStatements(
      SwitchSectionSyntax section)
    {
    ...
    private static IEnumerable<StatementSyntax> EnumerateExecutableStatements(
