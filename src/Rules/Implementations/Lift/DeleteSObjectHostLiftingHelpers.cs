...
{
    internal static IEnumerable<LiftedMarkRecord> BuildHostLiftedMarks(
      RuleContext context,
      string ruleId,
    ...
    private static SyntaxNode? TryLift(
    ...
    private static SyntaxNode? TryLiftExpression(
    ...
    private static bool TryLiftTransparentExpression(
      ExpressionSyntax expression,
      SyntaxNode ancestor,
      out SyntaxNode? host)
    {
    ...
    private static bool TryLiftAdditionalStatementExpression(
      ExpressionSyntax expression,
      SyntaxNode ancestor,
      out SyntaxNode? host)
    {
    ...
    private static SyntaxNode? TryLiftLogicalExpression(
    ...
    private static SyntaxNode? TryLiftVariableDeclarator(
    ...
    private static bool TryLiftControlHeaderExpression(
      ExpressionSyntax expression,
      SyntaxNode ancestor,
      CpgAnalysisContext context,
      out SyntaxNode? host)
