...
{
    internal static IEnumerable<LocalFunctionParameterUsagePayload> EnumeratePayloads(
    ...
    internal static bool TryBuildReplacement(
      LocalFunctionParameterUsagePayload payload,
...
{
    internal static IEnumerable<IndexerParameterUsagePayload> EnumeratePayloads(
      IReadOnlyList<PropagatedMarkRecord> propagatedMarks,
    ...
    internal static bool TryBuildReplacement(
      IndexerParameterUsagePayload payload,
    ...
    internal static IEnumerable<DecisionUnit> CreateAccessReplaceDecisions(
      string ruleId,
      Compilation compilation,
      IndexerParameterUsagePayload payload,
      string reason)
    ...
    private static bool TryBuildReplacementAccess(
      Compilation compilation,
      IndexerParameterUsagePayload payload,
      ElementAccessExpressionSyntax access,
      IParameterSymbol parameterSymbol,
      out ElementAccessExpressionSyntax replacementAccess)
    {
