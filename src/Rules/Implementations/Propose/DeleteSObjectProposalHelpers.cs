...
internal static class DeleteSObjectProposalHelpers
{
    ...
    internal static IReadOnlyList<(MarkRecord Mark, MarkRecord SourceMark)> EnumerateDerivedMarks(
    ...
    internal static IReadOnlyList<(MarkRecord Mark, MarkRecord SourceMark)> EnumerateActiveDerivedMarks(
      IReadOnlyList<PropagatedMarkRecord> propagatedMarks,
      IReadOnlyList<LiftedMarkRecord> liftedMarks)
    {
    ...
    internal static IEnumerable<MarkRecord> EnumerateUncoveredSeedMarks(
    ...
    internal static IEnumerable<LogicalHostPayload> EnumerateLogicalHostPayloads(
      IReadOnlyList<PropagatedMarkRecord> propagatedMarks)
    {
        return propagatedMarks
    ...
    internal static IEnumerable<IfStructureCompletionPayload> EnumerateIfStructureCompletionPayloads(
      IReadOnlyList<PropagatedMarkRecord> propagatedMarks)
    {
        return propagatedMarks
    ...
    internal static HashSet<(int Start, int Length, int RawKind)> BuildCoveredSeedKeys(
      IReadOnlyList<MarkRecord> seedMarks,
      IReadOnlyList<MarkRecord> propagatedMarks)
    {
    ...
    internal static ExpressionSyntax? BuildLogicalReplacement(
      LogicalHostPayload payload)
    {
    ...
    internal static DecisionUnit CreateLogicalReplaceDecision(
      string ruleId,
      BinaryExpressionSyntax anchorNode,
    ...
    internal static bool TryBuildIfStructureDecisionFromMark(
      string ruleId,
      IfStructureCompletionPayload payload,
      out DecisionUnit? decision,
      out IReadOnlyList<SyntaxNode> consumedNodes)
    {
        decision = null;
    ...
    internal static DecisionUnit CreateStatementReplaceDecision(
      string ruleId,
      StatementSyntax anchorNode,
      StatementSyntax replacementNode,
      string reason)
    {
        var anchorFragment = DecisionCpgFactory.CreateFragment(
          BuildFragmentId(anchorNode),
    ...
    internal static DecisionUnit CreateElseClauseReplaceDecision(
      string ruleId,
      ElseClauseSyntax anchorNode,
      ElseClauseSyntax replacementNode,
      string reason)
    {
        var anchorFragment = DecisionCpgFactory.CreateFragment(
          BuildFragmentId(anchorNode),
    ...
    internal static bool TryResolveMarkedIfStructure(
      RuleContext context,
      SyntaxNode markedNode,
      IfStructureAnalyzer ifStructureAnalyzer,
      out IfStructureAnalysis? ifAnalysis)
    {
        ifAnalysis = null;
    ...
    internal static IfStructureCompletionPayload? TryBuildIfStructureCompletionPayload(
      RuleContext context,
      SyntaxNode markedNode)
    {
