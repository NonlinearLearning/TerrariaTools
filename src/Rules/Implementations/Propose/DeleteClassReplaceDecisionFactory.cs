...
{
    internal static DecisionUnit CreateLocalFunctionReplaceDecision(
      string ruleId,
      LocalFunctionStatementSyntax anchorNode,
      LocalFunctionStatementSyntax replacementNode,
      string reason)
    {
    ...
    internal static DecisionUnit CreateMethodReplaceDecision(
      string ruleId,
    ...
    internal static DecisionUnit CreateInvocationReplaceDecision(
      string ruleId,
      InvocationExpressionSyntax anchorNode,
    ...
    internal static DecisionUnit CreateExpressionReplaceDecision(
      string ruleId,
      ExpressionSyntax anchorNode,
    ...
    internal static DecisionUnit CreateIndexerReplaceDecision(
      string ruleId,
      IndexerDeclarationSyntax anchorNode,
      IndexerDeclarationSyntax replacementNode,
      string reason)
    {
        return CreateMemberDeclarationReplaceDecision(ruleId, anchorNode, replacementNode, reason);
    }

    internal static DecisionUnit CreateDelegateReplaceDecision(
      string ruleId,
      DelegateDeclarationSyntax anchorNode,
      DelegateDeclarationSyntax replacementNode,
      string reason)
    {
        return CreateMemberDeclarationReplaceDecision(ruleId, anchorNode, replacementNode, reason);
    }

    internal static DecisionUnit CreateElementAccessReplaceDecision(
      string ruleId,
      ElementAccessExpressionSyntax anchorNode,
      ElementAccessExpressionSyntax replacementNode,
      string reason)
    {
        var anchorFragment = CreateFragment(anchorNode, "anchor", DecisionActionKind.Replace);
        var replacementFragment = CreateFragment(
    ...
    private static DecisionUnit CreateMemberDeclarationReplaceDecision<TNode>(
      string ruleId,
      TNode anchorNode,
